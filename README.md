...
<p align="center">
  <img width="604" height="673" alt="image" src="https://github.com/user-attachments/assets/b07bca95-77f6-47c7-af80-bea3f664809f" />
</p> 
...
| **Backend** | `Supabase` |
| **Database**| `PostgreSQL`(BE)`Sqlite`(local) |
